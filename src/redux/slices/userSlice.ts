...
const initialState: IUserState = {
  /*global Telegram*/
  // @ts-ignore
  hash: Telegram.WebApp.initDataUnsafe.hash || '018166a6eb0c192a4e927bbffbea6a6f7312ebf3ee97548354b9bd40921eb0cd',
  tgid: Telegram.WebApp.initDataUnsafe.user?.id || 475528761,
